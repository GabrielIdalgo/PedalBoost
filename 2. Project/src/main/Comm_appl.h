...
typedef struct{
    ...
    PedalCtrl PedalCtrlRequest = PedalCtr_Off;  /* Variável para indicar o estado do Pedal control (Response Handling Machine) */
}Uart_t;
...
/* CMD  Table Functions */
static Kostia_Rsp_t Comm_appl_OffModeReq (byte *pCmd, Uart_t *);
static Kostia_Rsp_t Comm_appl_SportModeReq (byte *pCmd, Uart_t *);
static Kostia_Rsp_t Comm_appl_ProtectModeReq(byte *pCmd, Uart_t *);
